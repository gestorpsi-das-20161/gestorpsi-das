...
urlpatterns = patterns('',
                       (r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/demographic/$', login_check(
                           home)),

                       (r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/demographic/education/$', login_check(
                           education)),
                       ...
                       (r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/demographic/occupation/(?P<occupation_id>(\d)+)/$', login_check(
                           occupation)),
                       (r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/demographic/occupation/save/$',
                           login_check(occupation_save)),
                       (r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/demographic/occupation/save/(?P<occupation_id>(\d)+)/$', login_check(
                           occupation_save)),
