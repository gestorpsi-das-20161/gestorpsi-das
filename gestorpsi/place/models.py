...
class Place(models.Model):
    ...
    hour_start = models.CharField(
        u'Primeiro horário', max_length=10, default='07,00', choices=HOURS)
    hour_end = models.CharField(
        u'Último horário', max_length=10, default='19,00', choices=HOURS)
    ...
    def hours_work(self):
        ...
        x = (float(self.hour_end.split(',')[
             0]) - float(self.hour_start.split(',')[0])) + m
