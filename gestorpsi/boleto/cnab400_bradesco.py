...
def readHeader(header):
    ...
    head["id_tipo_operacao"] = header[3:10]
    # 9 Identificação do Tipo de Serviço: “01”
    head["id_tipo_servico"] = header[10:12]
    # X Identificação por Extenso do Tipo de Serviço: “COBRANCA”
    head["tipo_servico"] = header[12:27]
    ...
    # 9 Data da Gravação: Informe no formato “DDMMAA”
    head["data_gravacao"] = header[95:101]
    ...
    head["sequencial_reg"] = header[395:401]
    return head
...
def readTrailer(trailer):
    ...
    trail["cob_simples_qtd_titulos"] = trailer[18:26]
    # 9  v99 Cobrança Simples - valor total
    trail["cob_simples_vlr_total"] = trailer[26:40]
    # 9  Cobrança Simples - Número do aviso
    trail["cob_simples_num_aviso"] = trailer[40:48]
    # Quantidade  de Registros- Ocorrência 02 – Confirmação de Entradas
    trail["qtd_regs02"] = trailer[58:63]
    # Valor dos Registros- Ocorrência 02 – Confirmação de Entradas
    trail["valor_regs02"] = trailer[63:75]
    # Valor dos Registros- Ocorrência 06 liquidacao
    trail["valor_regs06liq"] = trailer[75:87]
    # Quantidade  de Registros- Ocorrência 06 – liquidacao
    trail["qtd_regs06"] = trailer[87:92]
    # Valor dos Registros- Ocorrência 06
    trail["valor_regs06"] = trailer[92:104]
    # Quantidade  de Registros- Ocorrência 09 e 10
    trail["qtd_regs09"] = trailer[104:109]
    # Valor dos  Registros- Ocorrência 09 e 10
    trail["valor_regs02"] = trailer[109:121]
    # Quantidade  de Registros- Ocorrência 13
    trail["qtd_regs13"] = trailer[121:126]
    # Valor dos  Registros- Ocorrência 13
    trail["valor_regs13"] = trailer[126:138]
    # Quantidade  de Registros- Ocorrência 14
    trail["qtd_regs14"] = trailer[138:143]
    # Valor dos  Registros- Ocorrência 14
    trail["valor_regs14"] = trailer[143:155]
    # Quantidade  de Registros- Ocorrência 12
    trail["qtd_regs12"] = trailer[155:160]
    # Valor dos  Registros- Ocorrência 12
    trail["valor_regs12"] = trailer[160:172]
    # Quantidade  de Registros- Ocorrência 19
    trail["qtd_regs19"] = trailer[172:177]
    # Valor dos  Registros- Ocorrência 19
    trail["valor_regs19"] = trailer[177:189]
...
def cnab400():
    file = open(
        "/home/jayme/Desktop/doois/gestorpsi/retorno-cb030400-bradesco.ret", 'r+')
