...
class OcuppationForm(models.ModelForm):
    ...
    class Meta:
        model = Ocuppation
        fields = ('occupation', 'labor_market_status',
                  'workplace', 'working_hours', 'comments')
...
class SanitationForm(forms.ModelForm):
    ...
    class Meta:
        model = Sanitation
        fields = ('water_supply', 'water_treatment',
                  'sewer', 'waste_disposition', 'comments')
...
class DwellingFeaturesForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('location', 'situation', 'dwelling_type', 'rooms', 'construction_type',
                  'covering_floor', 'roof_material', 'coating_walls', 'comments')
