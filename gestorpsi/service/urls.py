...
urlpatterns = patterns('',
                       ...
                       # service group
                       (r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/group/add/$',
                           login_check(group_form)),
                       ...
                       (r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/group/$',
                           login_check(group_list)),
                       url(r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/group/json/$',
                           login_check(group_list), {'return_json': True}),
                       # deactive
                       ...
                       # list client - active
                       (r'^(?P<object_id>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/clientlist/$',
                           login_check(client_list_index)),  # mount html client list
                       ...
                       url(r'list/all/$', login_check(list_filter_covenant),
                           {'alls': True}),  # all services
                       url(r'list/indiv/$', login_check(list_filter_covenant),
                           {'indiv': True}),  # just group services
                       )
